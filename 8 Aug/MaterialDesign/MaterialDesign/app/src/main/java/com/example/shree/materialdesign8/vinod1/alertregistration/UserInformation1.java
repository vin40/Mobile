...
public class UserInformation1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acTextView.setAdapter(new SuggestionAdapter3(UserInformation1.this, acTextView.getText().toString()));
...
*/
        ...
        auto.setThreshold(1);
        auto.setAdapter(new SuggestionAdapter33(UserInformation1.this, auto.getText().toString()));
        ...
        btnnext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Inputuser.getText().toString().trim().length()== 0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(UserInformation1.this);
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            insertuser();
                            Intent i = new Intent(UserInformation1.this, UserInformation2.class);
                            startActivity(i);
                        }
                    });
                ...
                api.insertUser(Dfname.toString(),
                        ...
                        new Callback<Response>() {
                            ...
                            public void success(Response result, Response response2) {
                                ...
                                Toast.makeText(UserInformation1.this, output, Toast.LENGTH_LONG).show();

                            }

                            @Override
                            public void failure(RetrofitError error) {
                                Toast.makeText(UserInformation1.this, error.toString(), Toast.LENGTH_LONG).show();
                            }
                        });
