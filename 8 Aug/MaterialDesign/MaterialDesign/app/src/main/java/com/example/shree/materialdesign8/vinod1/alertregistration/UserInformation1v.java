...
public class UserInformation1v extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vertrinary);
        ...
        acTextView.setAdapter(new SuggestionAdapter7(UserInformation1v.this, acTextView.getText().toString()));
...
*/
        ...
        auto.setThreshold(1);
        auto.setAdapter(new SuggestionAdapter77(UserInformation1v.this, auto.getText().toString()));
        ...
        btnnext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Inputuser.getText().toString().trim().length()== 0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(UserInformation1v.this);
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            insertuser();
                            Intent i = new Intent(UserInformation1v.this, UserInformation2.class);
                            startActivity(i);
                        }
                    });
                ...
                api.insertUser(Dfname.toString(),
                        ...
                        new Callback<Response>() {
                            ...
                            public void success(Response result, Response response2) {
                                ...
                                Toast.makeText(UserInformation1v.this, output, Toast.LENGTH_LONG).show();

                            }

                            @Override
                            public void failure(RetrofitError error) {
                                Toast.makeText(UserInformation1v.this, error.toString(), Toast.LENGTH_LONG).show();
                            }
                        });
