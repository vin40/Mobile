...
public class UserInformation1h extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.homeopathy);
        ...
        acTextView.setAdapter(new SuggestionAdapter5(UserInformation1h.this, acTextView.getText().toString()));
...
*/
        ...
        auto.setThreshold(1);
        auto.setAdapter(new SuggestionAdapter55(UserInformation1h.this, auto.getText().toString()));
        ...
        btnnext1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Inputuser.getText().toString().trim().length()== 0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(UserInformation1h.this);
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            insertuser();
                            Intent i = new Intent(UserInformation1h.this, UserInformation2.class);
                            startActivity(i);
                        }
                    });
                ...
                api.insertUser(Dfname.toString(),
                        ...
                        new Callback<Response>() {
                            ...
                            public void success(Response result, Response response2) {
                                ...
                                Toast.makeText(UserInformation1h.this, output, Toast.LENGTH_LONG).show();

                            }

                            @Override
                            public void failure(RetrofitError error) {
                                Toast.makeText(UserInformation1h.this, error.toString(), Toast.LENGTH_LONG).show();
                            }
                        });
