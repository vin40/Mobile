 ...
 */
public class SpinnertDAdapter3 extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private List<DataObject> listData;
    private Context context;
    public SpinnertDAdapter3(Context context, List<DataObject> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.spinner_dlist3, parent, false);
