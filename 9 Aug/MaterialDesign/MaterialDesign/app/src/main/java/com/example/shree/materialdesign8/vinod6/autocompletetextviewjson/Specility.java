...
public class Specility extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        new GetHttpResponse(Specility.this).execute();
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
...

        {
            ...
            MobileArrayAdapter = new ArrayAdapter<String>(Specility.this,android.R.layout.simple_list_item_2, android.R.id.text1, MobileList);
