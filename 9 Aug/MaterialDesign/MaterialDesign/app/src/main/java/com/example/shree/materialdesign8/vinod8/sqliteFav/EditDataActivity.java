...
public class EditDataActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_data3);
        ...
        GetSQliteQuery = "SELECT * FROM demoTable13" ;
        ...
        updatebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
				...
				*/
                ...
                UpdateRecordQuery = "UPDATE demoTable13 SET name='" + GetName + "' WHERE id=" + UserID + ";";
        ...
        deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DeleteQuery = "DELETE FROM demoTable13 WHERE id=" + UserID + ";";
