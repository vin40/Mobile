...
public class ActivityDetailNamePatient extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_detail_namapatient);
       ...
       // btnAdd = (Button) findViewById(R.id.btnAdd);
        ...
        imageLoader = new ImageLoader(ActivityDetailNamePatient.this);
