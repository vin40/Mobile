...
public class SpecilityVetrinary extends AppCompatActivity
{
    ListView MobileDetailsListView;
    ProgressBar MobileProgressBar;
    String HttpUrl = "http://35.154.210.22/dpts/api/onclickfilter/Specilityvertinaty.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        new GetHttpResponse(SpecilityVetrinary.this).execute();
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
...

        {
            ...
            MobileArrayAdapter = new ArrayAdapter<String>(SpecilityVetrinary.this,android.R.layout.simple_list_item_2, android.R.id.text1, MobileList);
