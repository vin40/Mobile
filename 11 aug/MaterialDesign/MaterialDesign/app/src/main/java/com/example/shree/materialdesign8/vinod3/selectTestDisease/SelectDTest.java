...
import com.example.shree.materialdesign8.ConfirmationReport;
...
public class SelectDTest extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_dtest);
       ...
       Button b=(Button)findViewById(R.id.confirm);
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(SelectDTest.this, ConfirmationMassage.class);
                startActivity(i);
            }
        });
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, PATH_TO_SERVER, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(null != spinnerData){
                    ...
                    SpinnertAdapter2 spinnerAdapter = new SpinnertAdapter2(SelectDTest.this,spinnerData);
        ...
        StringRequest stringRequest3 = new StringRequest(Request.Method.GET, PATH_TO_SERVER, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(null != spinnerData){
                    ...
                    SpinnertAdapter3 spinnerAdapter = new SpinnertAdapter3(SelectDTest.this,spinnerData);
        ...
        StringRequest stringRequest4 = new StringRequest(Request.Method.GET, PATH_TO_SERVER, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(null != spinnerData){
                    ...
                    SpinnertAdapter4 spinnerAdapter = new SpinnertAdapter4(SelectDTest.this,spinnerData);
        ...
        StringRequest stringRequest5 = new StringRequest(Request.Method.GET, PATH_TO_SERVER, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(null != spinnerData){
                    ...
                    SpinnertAdapter5 spinnerAdapter = new SpinnertAdapter5(SelectDTest.this,spinnerData);
        ...
        StringRequest stringRequest6 = new StringRequest(Request.Method.GET, PATH_TO_SERVER, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(null != spinnerData){
                    ...
                    SpinnertAdapter6 spinnerAdapter = new SpinnertAdapter6(SelectDTest.this,spinnerData);
        ...
        StringRequest stringRequest7 = new StringRequest(Request.Method.GET, PATH_TO_SERVER, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(null != spinnerData){
                    ...
                    SpinnertAdapter7 spinnerAdapter = new SpinnertAdapter7(SelectDTest.this,spinnerData);
        ...
        StringRequest stringRequest8 = new StringRequest(Request.Method.GET, PATH_TO_SERVER, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(null != spinnerData){
                    ...
                    SpinnertAdapter8 spinnerAdapter = new SpinnertAdapter8(SelectDTest.this,spinnerData);
