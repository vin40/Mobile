...
public class ActivityDetailLabArea extends Activity {
	...
	String Menu_image, Menu_name, Menu_rating, Menu_description,Menu_timeline,Menu_discount,landline,mobileno ;
	double Menu_price;
	int Menu_quantity;
	long Menu_ID;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_detail_lab_area);

        ActionBar bar = getActionBar();
        bar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.header)));
        bar.setTitle("Lab Details");
       ...
       // btnAdd = (Button) findViewById(R.id.btnAdd);
        ...
        imageLoader = new ImageLoader(ActivityDetailLabArea.this);
        ...
        // Menu detail API url
        MenuDetailAPI = Constant.MenuDetailAPI2+"?accesskey="+Constant.AccessKey+"&menu_id="+Menu_ID;
     ...
     /*   btnAdd.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				// show input dialog
				*//*Intent I=new Intent(ActivityDetailNamePatient.this,RefUploadPhoto.class);
				startActivity(I);*//*
				//inputDialog();
			}
		});*/
    ...
    public class getDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if((Menu_name != null) && IOConnect == 0){
				...
				txtSubText.setText("Rating : " +Menu_rating+" "+"\n"+"Timeline : "+Menu_timeline+" "+"\n"+"Discount :"+Menu_discount+" "+"\n"+"landline  :"+landline+" "+"\n"+"mobile no :"+mobileno+" "+"\n");
    	...
    	try {
			...
			for (int i = 0; i < data.length(); i++) {
			   ...
			   // Menu_price = Double.valueOf(formatData.format(menu.getDouble("Price")));
			    Menu_rating = menu.getString("Rating");
				Menu_timeline = menu.getString("Timeline");
			    Menu_description = menu.getString("Description");
				Menu_discount=menu.getString("Discount");
				landline=menu.getString("landline");
				mobileno=menu.getString("mobile");
