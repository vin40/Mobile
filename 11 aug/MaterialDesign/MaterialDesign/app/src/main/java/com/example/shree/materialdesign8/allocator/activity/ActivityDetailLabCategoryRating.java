...
public class ActivityDetailLabCategoryRating extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_detail_labcategoryrating);

        ActionBar bar = getActionBar();
        bar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.header)));
        bar.setTitle("Lab Detail");
       ...
       // btnAdd = (Button) findViewById(R.id.btnAdd);
        ...
        imageLoader = new ImageLoader(ActivityDetailLabCategoryRating.this);
        ...
        // Menu detail API url
        MenuDetailAPI = Constant.MenuDetailAPI1+"?accesskey="+Constant.AccessKey+"&menu_id="+Menu_ID;
