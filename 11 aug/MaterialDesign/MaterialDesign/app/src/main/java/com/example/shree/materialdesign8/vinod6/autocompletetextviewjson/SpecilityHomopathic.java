...
public class SpecilityHomopathic extends AppCompatActivity {
    ListView MobileDetailsListView;
    ProgressBar MobileProgressBar;
    String HttpUrl = "http://35.154.210.22/dpts/api/onclickfilter/SpecilityHomopathy.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        new GetHttpResponse(SpecilityHomopathic.this).execute();
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
...

        {
            ...
            MobileArrayAdapter = new ArrayAdapter<String>(SpecilityHomopathic.this,android.R.layout.simple_list_item_2, android.R.id.text1, MobileList);
